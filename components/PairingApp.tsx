  ...
  return (
    <main className="pair-shell">
      <nav className="topbar pair-topbar" aria-label="เมนูหลัก">
        <button className="brand brand-button" onClick={() => void reset()} aria-label="กลับหน้าแรก">N2N<span>.</span><small className="version-mark">v1.3.7</small></button>
      ...
      {!session ? (
        ...
        <section className="room-layout">
          ...
          <section className="conversation" aria-label="พื้นที่รับส่งข้อมูล">
            ...
            <p className="transfer-limit-note">N2N v1.3.7 · เชื่อมต่อใหม่อัตโนมัติเมื่อกลับจากการเลือกไฟล์ · 30 ห้อง/10 นาที/IP</p>
